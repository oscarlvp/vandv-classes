...
We define _faults_, _errors_ and _failures_ as follows <<moller1993empirical>>, <<ghahrai2018error>>, <<amman2016introduction>>:
...
. [[amman2016introduction,({counter:references})]] Ammann, P., & Offutt, J. (2016). Introduction to software testing. Cambridge University Press.
