...
h| q1 | Value of `year`      | < 0 | 0  | valid leap year           | valid non leap year |    |
h| q1 | Value of `month`     | < 0 | 0  | { 1, 3, 5, 7, 8, 10, 12}  | { 4, 6, 9, 11 }     | 2  | > 12
h| q1 | Value of `day`       | < 0 | 0  | >= 1 and \<= max(`month`) | > `max(month)`      |    |
|===
